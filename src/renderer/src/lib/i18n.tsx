...
const es: Dict = {
  ...
  'security.keys.encrypted': 'Cifradas con las credenciales de Windows (DPAPI) en tu perfil. Nunca salen del equipo salvo hacia el propio proveedor.',
  'security.keys.fallback': 'El cifrado del sistema no está disponible: las claves se guardan codificadas, no cifradas. Revisa el llavero de tu sesión de Windows.',
  ...
  'files.trash': 'Mandar a la papelera',
